...
export const EachPage = [
  {
    name: "ChekkitApp",
    title: "a redesign on chekkitapp",
    description: "A counterfeit detection and reporting application to protect people from fraudulent products.",
    features: ["Case Study", "Anti-Counterfeit", "Mobile App"],
    color: "#9B51E0",
    bg: "#FCF9FF"
  },
  ...
  {
    name: "FlitWire",
    title: "flitwire’s mobile application",
    description: "Helping Nigerians in the Abroad precisely Canada to send money back home in a simple and secured portal.",
    features: ["Case Study", "Fintech", "Mobile App"],
    color: "#9B51E0",
    bg: "#FCF9FF"
  ...
  {
    name: "Warenext",
    title: "warenext’s website redesign",
    description: "Redesigning a logistics company’s website to improve its web presence, user experience and retention rate.",
    features: ["UI Design", "Logistics", "Website"],
    color: "#FB7921",
    bg: "#FCF9FF"
  ...
  {
    name: "Findconnect",
    title: "findConnect website landing page",
    description: "A landing page that allows you to find and verify any email address to make new connections and reach out to any business or company.",
    features: ["UI Design", "Verification", "Website"],
    color: "#9B51E0",
    bg: "#FCF9FF"
  ...
  {
    name: "Crystal",
    title: "crystal palace online ecommerce store",
    description: "An e-online store that sells Jewellery like rings,necklaces designed such that products are easily accessible to your customers and can increase your sales opportunities.",
    features: ["Case Study", "Anti-Counterfeit", "Mobile App"],
    color: "#9B51E0",
    bg: "#FCF9FF"
  },
